...
const ApprovalPipelineChart = ({ events }) => {
  const data = useMemo(() => {
    ...
    let pendingF = 0, pendingH = 0, pendingI = 0, pendingP = 0, approved = 0, rejected = 0;
    
    events.forEach(e => {
       switch(e.status) {
          case EventStatus.PENDING_FACULTY: pendingF++; break;
          case EventStatus.PENDING_HOD: pendingH++; break;
          case EventStatus.PENDING_IQAC: pendingI++; break;
          case EventStatus.PENDING_PRINCIPAL: pendingP++; break;
