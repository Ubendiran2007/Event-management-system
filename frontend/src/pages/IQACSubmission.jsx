...
const IQACSubmission = () => {
  ...
  const studentsAttendedFromRoster = studentAttendanceRoster.filter((item) => {
    // Basic multi-day heuristic: attended if they attended ANY day or must attend ALL? Usually, total unique attendees.
    // However, I'll count as attended overall if they attended all required days, or just use a simpler metric.
    // Let's say if they show up at least for one day.
